...
func TestMysql(t *testing.T) {
	...
	addr := fmt.Sprintf("%s:%s@tcp(%s:%d)/%s?timeout=1s&readTimeout=1s&writeTimeout=1s&parseTime=true&loc=Local&charset=utf8mb4,utf8", "dksl", "123456", "127.0.0.1", 3306, "employees")
